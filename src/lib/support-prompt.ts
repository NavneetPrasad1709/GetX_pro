...
# Seller payouts
Sellers withdraw their available (released, non-escrow) balance to UPI or crypto. Minimum withdrawal is ₹${(minPayoutMinor / 100).toLocaleString("en-IN")}. Payouts are typically processed within about 2 business days (T+2). Money held in escrow for active orders is never withdrawable until those orders complete.
